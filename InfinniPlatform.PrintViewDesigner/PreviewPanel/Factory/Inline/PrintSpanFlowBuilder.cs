...
{
    internal sealed class PrintSpanFlowBuilder : FlowBuilderBase<PrintSpan>
    {
        protected override object Build(FlowBuilderContext context, PrintSpan element, PrintDocumentMap documentMap)
        {
            var flowElement = new Span();
